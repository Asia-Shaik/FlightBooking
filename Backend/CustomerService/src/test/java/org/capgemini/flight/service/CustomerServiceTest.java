...
class CustomerServiceTest {
	...
	public void getallCustomerTest() {
		when(customerrepository.findAll()).thenReturn((List<Customer>)Stream.of(new Customer(456,"neha","bangalore",444444,"aj@gmail.com"),new Customer(555, "sneha","mangalore",888888,"mk@gmail.com")).collect(Collectors.toList()));
